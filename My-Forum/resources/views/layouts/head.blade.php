...
<div class="header">
    <div class="main">
        ...
        <div class="nav-user">
            ...
            <p class="out-login">
                <a href="{{route('auth.oauth',['driver'=>'qq'])}}" onclick="layer.msg('正在通过QQ登入', {icon:16, shade: 0.1, time:0})" class="iconfont icon-qq" title="QQ登入"></a>
                <a  href="{{route('auth.oauth',['driver'=>'weibo'])}}" onclick="layer.msg('正在通过微博登入', {icon:16, shade: 0.1, time:0})" class="iconfont icon-weibo" title="微博登入"></a>
            </p>
